...
add_field(ProtoField.int16, "input.frame.left_thumb_x", "Left Thumb X-Axis")
add_field(ProtoField.int16, "input.frame.left_thumb_y", "Left Thumb Y-Axis")
add_field(ProtoField.int16, "input.frame.right_thumb_x", "Right Thumb X-Axis")
add_field(ProtoField.int16, "input.frame.right_thumb_y", "Right Thumb Y-Axis")
